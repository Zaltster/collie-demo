...
ENV WENDY_PLATFORM=nvidia-jetson \
    ...
    COLLIE_PRODUCE_CLASS_THRESHOLDS="apple=0.80,banana=0.20,pear=0.80" \
    ...
    COLLIE_DIRECT_TURN_ENABLED=1 \
    COLLIE_MEMORY_SAMPLES=5 \
    COLLIE_MEMORY_CAPTURE_TIMEOUT_S=2.0 \
    COLLIE_INSTANCE_MATCH_SCORE=0.76 \
    COLLIE_INSTANCE_MATCH_MARGIN=0.06 \
    COLLIE_SAVED_INSTANCE_REJECTION_SCORE=0.94 \
    COLLIE_MATCH_CONFIRMATIONS=2 \
    COLLIE_APPROACH_MATCH_MISSES=2 \
    ...
    COLLIE_SEARCH_RATE_RPS=0.20 \
    COLLIE_SEARCH_SWEEP_DEG=75 \
    COLLIE_SEARCH_TIMEOUT_S=9 \
